...
export default async function ClientsPage({ searchParams }: { searchParams: Promise<{ view?: string }> }) {
  ...
  return <main className="mx-auto max-w-[1500px] px-4 py-7 sm:px-6 lg:px-8 lg:py-9"><AdminPageHeader eyebrow="Relationships" title="Clients & Leads" description="Move prospective clients toward a thoughtful assessment while keeping active property relationships visible." actions={<Link href="/admin/clients/new" className={adminPrimaryButton}><Plus aria-hidden="true" className="size-4" />New Client</Link>} />
